    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Event Paper Riview Add</h3>
            </div>
            <?php echo form_open('event_paper_riview/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="komentar" class="form-control" id="komentar"><?php echo $this->input->post('komentar'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
