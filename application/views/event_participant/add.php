    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Event Participant Add</h3>
            </div>
            <?php echo form_open('event_participant/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="id_event" value="<?php echo $this->input->post('id_event'); ?>" class="form-control" id="id_event" />
						</div>
					</div>
					<div class="col-md-6">
